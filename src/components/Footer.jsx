function Footer() {
  const partners = [
    ...
    { src: "./assets/partners/Bricomarché_logo_2022.svg.png", alt: "Bricomarché" },
    ...
    { src: "./assets/partners/le_moulin_de_sarré_logo.png", alt: "Moulin de Sarré" },
  ...
  return (
    <footer className="bg-gradient-to-b from-[#A3D7E9] to-[#5C6BC0] text-[#EAF8FF] font-baseRegular relative">
      {/* Section principale */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-start space-x-6">
              ...
              <div>
                <p className="bg-[#0E1A40] text-[#DEFCF0] text-lg mb-4 font-medium px-3 py-1 rounded inline-block">
                  Festival musical & artistique
                </p>
                <div className="space-y-3 text-[#DEFCF0]">
                  <div className="flex items-center space-x-3">
                    <span className="text-[#73C7E3] text-lg">📅</span>
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-xl font-bold mb-6 bg-[#0E1A40] text-[#DEFCF0] px-3 py-1 rounded">
              Navigation
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={idx}>
                  <a
                    href={item.href}
                    className="text-[#DEFCF0] hover:text-white transition-colors duration-200 hover:translate-x-1 transform block"
                  >
                    {item.label}
                  </a>
                </li>
            ...
            <div className="flex space-x-4">
              {["#", "#", "#", "#"].map((link, idx) => (
                <a
                  key={idx}
                  href={link}
                  className="text-[#CFE8F5] hover:text-[#73C7E3] transition-all duration-200 transform hover:scale-110 hover:-translate-y-1"
                >
      ...
      {/* Section partenaires */}
      <div className="border-t border-[#EAF8FF]/30 bg-[#EAF8FF]/10">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center mb-10">
            <h3 className="text-3xl font-bold bg-[#0E1A40] text-white px-4 py-2 rounded inline-block mb-4">
              Nos Partenaires
            </h3>
            <p className="text-[#CFE8F5] text-lg max-w-2xl mx-auto">
      ...
      {/* Copyright */}
      <div className="border-t border-[#EAF8FF]/30">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center text-sm text-[#CFE8F5]">
          <div>© 2025 Felicità Festival. Tous droits réservés.</div>
          <a href="/contact" className="hover:text-[#73C7E3] transition-colors duration-200">
            Contact
          </a>
        </div>
      </div>
