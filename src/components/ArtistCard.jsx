...
function ArtistCard({ artist }) {
  ...
  return (
    <div className="relative group">
      {/* Carte avec hauteur ajustable - teste ces différentes options : */}
      {/* Option 1: Rectangle légèrement plus haut que large */}
      ...
      {/* Option 2: Hauteur fixe (décommente pour tester)
      <div className="w-full h-96 bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
      */}
      
      {/* Option 3: Hauteur fixe plus précise (décommente pour tester)
      <div className="w-full h-[420px] bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
      */}
      
      {/* Option 4: Carré parfait (original)
      <div className="w-full aspect-square bg-white rounded-lg shadow-lg overflow-hidden cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
      */}
