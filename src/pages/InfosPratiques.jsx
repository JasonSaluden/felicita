  ...
  return (
    <div className="min-h-screen bg-[#FFF8C9]">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-16">
                  ...
                  <div className="bg-white/70 p-6 rounded-2xl border border-gray-200">
                    ...
                    {[
                      ...
                      },
                      {
                        ...
                        desc: "Galettes de sarasin Végés et Carnivores",
        ...
        {/* Informations générales - affichées sur tous les onglets */}
        <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="bg-white/70 p-4 rounded-xl border border-gray-200">
                  ...
                  <p className="text-gray-600">
                   Poubelles à disposition, gobelets consignés, toilettes sèches
                  </p>
                </div>
                ...
                <div className="bg-white/70 p-4 rounded-xl border border-gray-200">
                  ...
                  <p className="text-gray-600">
                    Espace famille, animations et jeux pour enfants
                  </p>
                </div>
              </div>
            </div>
